# ============================================================
# This file is derived from the original pix2pix/CycleGAN
# research codebase (BSD License), Copyright (c) 2017,
# Jun-Yan Zhu and Taesung Park; Copyright (c) 2016, Phillip
# Isola and Jun-Yan Zhu. Included here for architecture
# reference, per the original BSD license terms.
# ============================================================
...
def define_G(input_nc, output_nc, ngf, netG, norm="batch", use_dropout=False, init_type="normal", init_gain=0.02):
    ...
    elif netG == 'unet_512':   # ← added: 9 downsampling layers, for resolutions that are multiples of 512
